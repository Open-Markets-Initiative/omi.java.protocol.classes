...
/**
* Java parser for Nasdaq Phlx Itch MarketDepth 1.6 protocol
* 
* @version 1.0
* @since 04/25/2021 15:26:15
*/

public class NasdaqPhlxMarketDepthItchv16 {
    ...
    */
    public enum ENUM_CURRENT_TRADING_STATE {
        E_H('H', "Halt"),
        E_T('T', "Trading"),
        E_B('B', "Buy Side Trading Suspended Or Exhausted"),
        E_S('S', "Sell Side Trading Suspended Or Exhausted");
    ...
    */
    public enum ENUM_EVENT_CODE {
        ...
        E_S('S', "Start Of System Hours This Message Indicates That Phlx® Is Open And Ready To Start Accepting Orders"),
        E_Q('Q', "Start Of Opening Process This Message Is Intended To Indicate That Phlx® Has Started Its Opening Auction Process"),
        E_N('N', "End Of Normal Hours Processing This Message Is Intended To Indicate That Phlx® Will No Longer Accept Any New Orders Or Changes To Existing Orders For Options That Trade During Normal Trading Hours"),
        E_L('L', "End Of Late Hours Processing This Message Is Intended To Indicate That Phlx® Will No Longer Accept Any New Orders Or Changes To Existing Orders For Options That Trade During Extended Hours"),
        E_E('E', "End Of System Hours This Message Indicates That Phlx® Options System Is Now Closed"),
        E_C('C', "End Of Messages This Is Always The Last Message Sent In Any Trading Day"),
        E_W('W', "End Of Wco Early Closing This Message Is Intended To Indicate That The Exchange Will No Longer Accept Any New Orders Or Changes To Existing Orders On Last Trading Date Of Wco Options");
    ...
    */
    public enum ENUM_MESSAGE_TYPE {
        ...
        E_a('a', "Add Order Short Message"),
        E_A('A', "Add Order Long Message"),
        E_j('j', "Add Quote Short Message"),
        E_J('J', "Add Quote Long Message"),
        E_E('E', "Single Side Executed Message"),
        E_C('C', "Single Side Executed With Price Message"),
        E_X('X', "Single Side Cancel Message"),
        E_u('u', "Single Side Replace Short Message"),
        E_U('U', "Single Side Replace Long Message"),
        E_v('v', "Order Replace Short Message"),
        E_V('V', "Order Replace Long Message"),
        E_D('D', "Single Side Delete Message"),
        E_G('G', "Single Side Update Message"),
        E_k('k', "Quote Replace Short Message"),
        E_K('K', "Quote Replace Long Message"),
    ...
    */
    public static class QuoteReplaceLongMessage implements Payload {
        ...
        // constructor for Quote Replace Long Message
        private QuoteReplaceLongMessage(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Quote Replace Long Message
        public static QuoteReplaceLongMessage parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new QuoteReplaceLongMessage(parentElement);
    ...
    public static class ShortAskPrice implements IBinaryProtocolElement {
        public static final int LENGTH = 2;
        public final IBinaryProtocolElement parent;
        public final Short value;

        public ShortAskPrice(Short value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static ShortAskPrice parse(Container container, IBinaryProtocolElement element) {
            return new ShortAskPrice(BigEndianUtils.toShort(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "shortAskPrice = "+ this.value;
        }
    }
    ...
    public static class ShortBidPrice implements IBinaryProtocolElement {
        public static final int LENGTH = 2;
        public final IBinaryProtocolElement parent;
        public final Short value;

        public ShortBidPrice(Short value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static ShortBidPrice parse(Container container, IBinaryProtocolElement element) {
            return new ShortBidPrice(BigEndianUtils.toShort(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "shortBidPrice = "+ this.value;
        }
    }
    ...
    */
    public static class QuoteReplaceShortMessage implements Payload {
        ...
        // constructor for Quote Replace Short Message
        private QuoteReplaceShortMessage(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Quote Replace Short Message
        public static QuoteReplaceShortMessage parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new QuoteReplaceShortMessage(parentElement);
            ...
            element.originalAskReferenceNumberDelta = OriginalAskReferenceNumberDelta.parse(container, element);
            element.askReferenceNumberDelta = AskReferenceNumberDelta.parse(container, element);
            element.shortBidPrice = ShortBidPrice.parse(container, element);
            element.shortBidSize = ShortBidSize.parse(container, element);
            element.shortAskPrice = ShortAskPrice.parse(container, element);
        ...
        public String toString() {
            ...
            sb.append(this.originalAskReferenceNumberDelta).append("\n");
            sb.append(this.askReferenceNumberDelta).append("\n");
            sb.append(this.shortBidPrice).append("\n");
            sb.append(this.shortBidSize).append("\n");
            sb.append(this.shortAskPrice).append("\n");
    ...
    */
    public static class OrderReplaceLongMessage implements Payload {
        ...
        // constructor for Order Replace Long Message
        private OrderReplaceLongMessage(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Order Replace Long Message
        public static OrderReplaceLongMessage parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new OrderReplaceLongMessage(parentElement);
    ...
    */
    public static class OrderReplaceShortMessage implements Payload {
        ...
        // constructor for Order Replace Short Message
        private OrderReplaceShortMessage(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Order Replace Short Message
        public static OrderReplaceShortMessage parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new OrderReplaceShortMessage(parentElement);
    ...
    */
    public static class SingleSideReplaceLongMessage implements Payload {
        ...
        // constructor for Single Side Replace Long Message
        private SingleSideReplaceLongMessage(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Single Side Replace Long Message
        public static SingleSideReplaceLongMessage parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new SingleSideReplaceLongMessage(parentElement);
    ...
    */
    public static class SingleSideReplaceShortMessage implements Payload {
        ...
        // constructor for Single Side Replace Short Message
        private SingleSideReplaceShortMessage(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Single Side Replace Short Message
        public static SingleSideReplaceShortMessage parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new SingleSideReplaceShortMessage(parentElement);
    ...
    */
    public static class AddQuoteLongMessage implements Payload {
        ...
        // constructor for Add Quote Long Message
        private AddQuoteLongMessage(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Add Quote Long Message
        public static AddQuoteLongMessage parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new AddQuoteLongMessage(parentElement);
    ...
    */
    public static class AddQuoteShortMessage implements Payload {
        ...
        // constructor for Add Quote Short Message
        private AddQuoteShortMessage(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Add Quote Short Message
        public static AddQuoteShortMessage parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new AddQuoteShortMessage(parentElement);
    ...
    */
    public static class AddOrderLongMessage implements Payload {
        ...
        // constructor for Add Order Long Message
        private AddOrderLongMessage(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Add Order Long Message
        public static AddOrderLongMessage parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new AddOrderLongMessage(parentElement);
    ...
    */
    public static class AddOrderShortMessage implements Payload {
        ...
        // constructor for Add Order Short Message
        private AddOrderShortMessage(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Add Order Short Message
        public static AddOrderShortMessage parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new AddOrderShortMessage(parentElement);
    ...
    */
    public static Payload parsePayload(Container container, ENUM_MESSAGE_TYPE messageType) {
        ...
        // -- parsing Add Order Short Message
        if (messageType.enumType == 'a') {
            return AddOrderShortMessage.parse(container, null);
        }
        // -- parsing Add Order Long Message
        if (messageType.enumType == 'A') {
            return AddOrderLongMessage.parse(container, null);
        }
        // -- parsing Add Quote Short Message
        if (messageType.enumType == 'j') {
            return AddQuoteShortMessage.parse(container, null);
        }
        // -- parsing Add Quote Long Message
        if (messageType.enumType == 'J') {
            return AddQuoteLongMessage.parse(container, null);
        }
        ...
        // -- parsing Single Side Replace Short Message
        if (messageType.enumType == 'u') {
            return SingleSideReplaceShortMessage.parse(container, null);
        }
        // -- parsing Single Side Replace Long Message
        if (messageType.enumType == 'U') {
            return SingleSideReplaceLongMessage.parse(container, null);
        }
        // -- parsing Order Replace Short Message
        if (messageType.enumType == 'v') {
            return OrderReplaceShortMessage.parse(container, null);
        }
        // -- parsing Order Replace Long Message
        if (messageType.enumType == 'V') {
            return OrderReplaceLongMessage.parse(container, null);
        }
        ...
        // -- parsing Quote Replace Short Message
        if (messageType.enumType == 'k') {
            return QuoteReplaceShortMessage.parse(container, null);
        }
        // -- parsing Quote Replace Long Message
        if (messageType.enumType == 'K') {
            return QuoteReplaceLongMessage.parse(container, null);
        }
