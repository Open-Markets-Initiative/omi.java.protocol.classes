...
/**
* Java parser for Nasdaq Psx Itch TotalView 5.0 protocol
* 
* @version 1.0
* @since 04/25/2021 16:10:25
*/

public class NasdaqPsxTotalViewItchv50 {
    ...
    */
    public static class TradeMessageNonCross implements Payload {
        ...
        // constructor for Trade Message Non Cross
        private TradeMessageNonCross(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Trade Message Non Cross
        public static TradeMessageNonCross parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new TradeMessageNonCross(parentElement);
    ...
    */
    public static Payload parsePayload(Container container, ENUM_MESSAGE_TYPE messageType) {
        ...
        // -- parsing Trade Message Non Cross
        if (messageType.enumType == 'P') {
            return TradeMessageNonCross.parse(container, null);
        }
