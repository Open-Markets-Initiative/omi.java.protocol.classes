...
/**
* Java parser for Nasdaq Bx Equities Itch TotalView 5.0 protocol
* 
* @version 1.0
* @since 04/25/2021 15:26:15
*/

public class NasdaqBxEquitiesTotalViewItchv50 {
    ...
    */
    public enum ENUM_FINANCIAL_STATUS_INDICATOR {
        ...
        E_C('C', "Creations And Or Redemptions Suspended"),
        E_N('N', "Normal");
    ...
    */
    public enum ENUM_INVERSE_INDICATOR {
        E_Y('Y', "Is An Inverse Etp"),
        E_N('N', "Not An Inverse Etp");
    ...
    */
    public enum ENUM_MESSAGE_TYPE {
        ...
        E_F('F', "Add Order Mpid Attribution Message"),
    ...
    */
    public enum ENUM_OPERATIONAL_HALT_ACTION {
        E_H('H', "Operationally Halted"),
        E_B('B', "Operational Halt Has Been Lifted");
    ...
    */
    public enum ENUM_REG_SHO_ACTION {
        E_0('0', "No Price"),
        E_1('1', "Reg Sho Short Sale Price Test Restriction In Effect Due"),
        E_2('2', "Test Restriction Remains In Effect");
    ...
    */
    public enum ENUM_ROUND_LOTS_ONLY {
        ...
        E_N('N', "No Order Size Restrictions");
    ...
    */
    ...
    public static class CancelledShares implements IBinaryProtocolElement {
        public static final int LENGTH = 4;
        public final IBinaryProtocolElement parent;
        public final Integer value;

        public CancelledShares(Integer value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static CancelledShares parse(Container container, IBinaryProtocolElement element) {
            return new CancelledShares(BigEndianUtils.toInteger(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "cancelledShares = "+ this.value;
        }
    }
    ...
    */
    public static class OrderCancelMessage implements Payload {
        ...
        public Timestamp timestamp;
        public OrderReferenceNumber orderReferenceNumber;
        public CancelledShares cancelledShares;
        ...
        public static OrderCancelMessage parse(Container container, IBinaryProtocolElement parentElement) {
            ...
            element.timestamp = Timestamp.parse(container, element);
            element.orderReferenceNumber = OrderReferenceNumber.parse(container, element);
            element.cancelledShares = CancelledShares.parse(container, element);
        ...
        public String toString() {
            ...
            sb.append(this.timestamp).append("\n");
            sb.append(this.orderReferenceNumber).append("\n");
            sb.append(this.cancelledShares).append("\n");
            return sb.toString();
        }
    }
    ...
    */
    public static class AddOrderMpidAttributionMessage implements Payload {
        ...
        // constructor for Add Order Mpid Attribution Message
        private AddOrderMpidAttributionMessage(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Add Order Mpid Attribution Message
        public static AddOrderMpidAttributionMessage parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new AddOrderMpidAttributionMessage(parentElement);
    ...
    */
    public static Payload parsePayload(Container container, ENUM_MESSAGE_TYPE messageType) {
        ...
        // -- parsing Add Order Mpid Attribution Message
        if (messageType.enumType == 'F') {
            return AddOrderMpidAttributionMessage.parse(container, null);
        }
