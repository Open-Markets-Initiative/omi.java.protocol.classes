...
/**
* Java parser for Cme Futures Sbe Mdp3 1.11 protocol
* 
* @version 1.0
* @since 04/25/2021 15:26:15
*/

public class CmeFuturesMdp3Sbev111 {
    ...
    */
    public enum ENUM_AGGRESSOR_INDICATOR {
        E_255(255, "No Value"),
        E_0(0, "Not Aggressor"),
        E_1(1, "Aggressor");
        ...
        ENUM_AGGRESSOR_INDICATOR(Integer enumType, String enumValue) {
            this.enumType = enumType;
            this.enumValue = enumValue;
        }

        private static final Map<Integer, ENUM_AGGRESSOR_INDICATOR> BY_VALUE = new HashMap<>();

        static {
            for (ENUM_AGGRESSOR_INDICATOR s: values()) {
                BY_VALUE.put(s.enumType, s);
            }
        }

        public static ENUM_AGGRESSOR_INDICATOR valueOf(Integer s)  {
    ...
    */
    public enum ENUM_MD_SECURITY_TRADING_STATUS {
        ...
        E_26(26, "Post Close"),
        E_103(103, "No Change"),
        E_201(201, "Private Workup"),
        E_202(202, "Public Workup");
    ...
    * Md Stream Id Values
    */
    public enum ENUM_MD_STREAM_ID {
        E_255(255, "No Value"),
        E_0(0, "Market Place Assistant"),
        E_1(1, "Globex"),
        E_2(2, "Refinitiv"),
        E_3(3, "Icap");
        ...
        ENUM_MD_STREAM_ID(Integer enumType, String enumValue) {
            this.enumType = enumType;
            this.enumValue = enumValue;
        }

        private static final Map<Integer, ENUM_MD_STREAM_ID> BY_VALUE = new HashMap<>();

        static {
            for (ENUM_MD_STREAM_ID s: values()) {
                BY_VALUE.put(s.enumType, s);
            }
        }

        public static ENUM_MD_STREAM_ID valueOf(Integer s)  {
            return BY_VALUE.get(s);
        }
    }
    ...
    */
    public enum ENUM_MONEY_OR_PAR {
        ...
        ENUM_MONEY_OR_PAR(Integer enumType, String enumValue) {
            this.enumType = enumType;
            this.enumValue = enumValue;
        }

        private static final Map<Integer, ENUM_MONEY_OR_PAR> BY_VALUE = new HashMap<>();

        static {
            for (ENUM_MONEY_OR_PAR s: values()) {
                BY_VALUE.put(s.enumType, s);
            }
        }

        public static ENUM_MONEY_OR_PAR valueOf(Integer s)  {
            return BY_VALUE.get(s);
        }
    }
    ...
    */
    public enum ENUM_OPEN_CLOSE_SETTL_FLAG {
        ...
        E_100(100, "Intraday Vwap"),
        E_101(101, "Repo Average 830 Am"),
        E_102(102, "Repo Average 10 Am"),
        E_103(103, "Prev Session Repo Average 10 Am");
    ...
    */
    public enum ENUM_REPO_SUB_TYPE {
        E_0(0, "Special"),
        E_1(1, "Gc"),
        E_2(2, "Gc For Dbv");
        ...
        ENUM_REPO_SUB_TYPE(Integer enumType, String enumValue) {
            this.enumType = enumType;
            this.enumValue = enumValue;
        }

        private static final Map<Integer, ENUM_REPO_SUB_TYPE> BY_VALUE = new HashMap<>();

        static {
            for (ENUM_REPO_SUB_TYPE s: values()) {
                BY_VALUE.put(s.enumType, s);
            }
        }

        public static ENUM_REPO_SUB_TYPE valueOf(Integer s)  {
            return BY_VALUE.get(s);
        }
    }
    ...
    */
    public enum ENUM_SECURITY_ALT_ID_SOURCE {
        E_255(255, "No Value"),
        E_1(1, "Cusip"),
        E_4(4, "Isin");
        ...
        ENUM_SECURITY_ALT_ID_SOURCE(Integer enumType, String enumValue) {
            this.enumType = enumType;
            this.enumValue = enumValue;
        }

        private static final Map<Integer, ENUM_SECURITY_ALT_ID_SOURCE> BY_VALUE = new HashMap<>();

        static {
            for (ENUM_SECURITY_ALT_ID_SOURCE s: values()) {
                BY_VALUE.put(s.enumType, s);
            }
        }

        public static ENUM_SECURITY_ALT_ID_SOURCE valueOf(Integer s)  {
            return BY_VALUE.get(s);
        }
    }
    ...
    */
    public enum ENUM_SIDE {
        ...
        ENUM_SIDE(Integer enumType, String enumValue) {
            this.enumType = enumType;
            this.enumValue = enumValue;
        }

        private static final Map<Integer, ENUM_SIDE> BY_VALUE = new HashMap<>();
        ...
        public static ENUM_SIDE valueOf(Integer s)  {
            return BY_VALUE.get(s);
        }
    }
    ...
    */
    public enum ENUM_TEMPLATE_ID {
        ...
        E_57(57, "Md Instrument Definition Fixed Income"),
        E_58(58, "Md Instrument Definition Repo"),
        E_59(59, "Snapshot Refresh Top Orders"),
        E_60(60, "Security Status Workup"),
        E_61(61, "Snapshot Full Refresh Tcp"),
        E_62(62, "Collateral Market Value");
    ...
    */
    public enum ENUM_UNDERLYING_SECURITY_ALT_ID_SOURCE {
        E_255(255, "No Value"),
        E_1(1, "Cusip"),
        E_4(4, "Isin");
        ...
        ENUM_UNDERLYING_SECURITY_ALT_ID_SOURCE(Integer enumType, String enumValue) {
            this.enumType = enumType;
            this.enumValue = enumValue;
        }

        private static final Map<Integer, ENUM_UNDERLYING_SECURITY_ALT_ID_SOURCE> BY_VALUE = new HashMap<>();

        static {
            for (ENUM_UNDERLYING_SECURITY_ALT_ID_SOURCE s: values()) {
                BY_VALUE.put(s.enumType, s);
            }
        }

        public static ENUM_UNDERLYING_SECURITY_ALT_ID_SOURCE valueOf(Integer s)  {
            return BY_VALUE.get(s);
        }
    }
    ...
    */
    public enum ENUM_WORKUP_TRADING_STATUS {
        E_17(17, "Ready To Trade"),
        E_18(18, "Not Available For Trading"),
        E_201(201, "Private Workup"),
        E_202(202, "Public Workup");
        ...
        ENUM_WORKUP_TRADING_STATUS(Integer enumType, String enumValue) {
            this.enumType = enumType;
            this.enumValue = enumValue;
        }

        private static final Map<Integer, ENUM_WORKUP_TRADING_STATUS> BY_VALUE = new HashMap<>();

        static {
            for (ENUM_WORKUP_TRADING_STATUS s: values()) {
                BY_VALUE.put(s.enumType, s);
            }
        }

        public static ENUM_WORKUP_TRADING_STATUS valueOf(Integer s)  {
            return BY_VALUE.get(s);
        }
    }
    ...
    public static class MdStreamId implements IBinaryProtocolElement {
        public static final int LENGTH = 1;
        public final IBinaryProtocolElement parent;
        public final ENUM_MD_STREAM_ID value;

        public MdStreamId(ENUM_MD_STREAM_ID value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static MdStreamId parse(Container container, IBinaryProtocolElement element) {
            return new MdStreamId(ENUM_MD_STREAM_ID.valueOf((int)LittleEndianUtils.toByte(container, LENGTH)), element);
        }

        @Override
        public String toString() {
            return "mdStreamId = "+ this.value.enumType +" ("+ this.value.enumValue +")";
        }
    }

    // Underlying Instrument Guid: 8 Byte Unsigned Fixed Width Integer
    public static class UnderlyingInstrumentGuid implements IBinaryProtocolElement {
        public static final int LENGTH = 8;
        public final IBinaryProtocolElement parent;
        public final Long value;

        public UnderlyingInstrumentGuid(Long value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static UnderlyingInstrumentGuid parse(Container container, IBinaryProtocolElement element) {
            return new UnderlyingInstrumentGuid(LittleEndianUtils.toLong(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "underlyingInstrumentGuid = "+ this.value;
        }
    }

    // Dirty Price: 8 Byte Signed Fixed Width Integer
    public static class DirtyPrice implements IBinaryProtocolElement {
        public static final int LENGTH = 8;
        public final IBinaryProtocolElement parent;
        public final Long value;

        public DirtyPrice(Long value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value/1000000000;
        }

        public static DirtyPrice parse(Container container, IBinaryProtocolElement element) {
            return new DirtyPrice(LittleEndianUtils.toLong(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "dirtyPrice = "+ this.value;
        }
    }

    // Collateral Market Price: 8 Byte Signed Fixed Width Integer
    public static class CollateralMarketPrice implements IBinaryProtocolElement {
        public static final int LENGTH = 8;
        public final IBinaryProtocolElement parent;
        public final Long value;

        public CollateralMarketPrice(Long value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value/1000000000;
        }

        public static CollateralMarketPrice parse(Container container, IBinaryProtocolElement element) {
            return new CollateralMarketPrice(LittleEndianUtils.toLong(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "collateralMarketPrice = "+ this.value;
        }
    }

    // Underlying Security Alt Id Source: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
    public static class UnderlyingSecurityAltIdSource implements IBinaryProtocolElement {
        public static final int LENGTH = 1;
        public final IBinaryProtocolElement parent;
        public final ENUM_UNDERLYING_SECURITY_ALT_ID_SOURCE value;

        public UnderlyingSecurityAltIdSource(ENUM_UNDERLYING_SECURITY_ALT_ID_SOURCE value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static UnderlyingSecurityAltIdSource parse(Container container, IBinaryProtocolElement element) {
            return new UnderlyingSecurityAltIdSource(ENUM_UNDERLYING_SECURITY_ALT_ID_SOURCE.valueOf((int)LittleEndianUtils.toByte(container, LENGTH)), element);
        }

        @Override
        public String toString() {
            return "underlyingSecurityAltIdSource = "+ this.value.enumType +" ("+ this.value.enumValue +")";
        }
    }

    // Underlying Security Alt Id: 12 Byte Ascii String
    public static class UnderlyingSecurityAltId implements IBinaryProtocolElement {
        public static final int LENGTH = 12;
        public final IBinaryProtocolElement parent;
        public final String value;

        public UnderlyingSecurityAltId(String value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static UnderlyingSecurityAltId parse(Container container, IBinaryProtocolElement element) {
            return new UnderlyingSecurityAltId(BigEndianUtils.toString(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "underlyingSecurityAltId = "+ this.value;
        }
    }
    ...
    */
    public static class CollateralMarketValueGroup implements Payload {
        ...
        // constructor for Collateral Market Value Group
        private CollateralMarketValueGroup(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Collateral Market Value Group
        public static CollateralMarketValueGroup parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new CollateralMarketValueGroup(parentElement);

            element.underlyingSecurityAltId = UnderlyingSecurityAltId.parse(container, element);
            element.underlyingSecurityAltIdSource = UnderlyingSecurityAltIdSource.parse(container, element);
            element.collateralMarketPrice = CollateralMarketPrice.parse(container, element);
            element.dirtyPrice = DirtyPrice.parse(container, element);
            element.underlyingInstrumentGuid = UnderlyingInstrumentGuid.parse(container, element);
            element.mdStreamId = MdStreamId.parse(container, element);
        ...
        public String toString() {
            ...
            sb.append(this.underlyingSecurityAltId).append("\n");
            sb.append(this.underlyingSecurityAltIdSource).append("\n");
            sb.append(this.collateralMarketPrice).append("\n");
            sb.append(this.dirtyPrice).append("\n");
            sb.append(this.underlyingInstrumentGuid).append("\n");
            sb.append(this.mdStreamId).append("\n");
    ...
    */
    public static class CollateralMarketValueGroups implements Payload {
        ...
        public List<CollateralMarketValueGroup> collateralMarketValueGroupList = new ArrayList<>();

        // constructor for Collateral Market Value Groups
        private CollateralMarketValueGroups(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Collateral Market Value Groups
        public static CollateralMarketValueGroups parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new CollateralMarketValueGroups(parentElement);
            ...
            for (int i = 0; i < element.groupSize.numInGroup.value; i++) {
                element.collateralMarketValueGroupList.add(CollateralMarketValueGroup.parse(container, element));
            }
        ...
        public String toString() {
            ...
            for (var collateralMarketValueGroup: collateralMarketValueGroupList) {
                sb.append(collateralMarketValueGroup).append("\n");
            }
            return sb.toString();
        }
    }
    ...
    /**
    * Collateral Market Value 62
    */
    public static class CollateralMarketValue62 implements Payload {
        ...
        public Padding2 padding2;
        public CollateralMarketValueGroups collateralMarketValueGroups;

        // constructor for Collateral Market Value 62
        private CollateralMarketValue62(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Collateral Market Value 62
        public static CollateralMarketValue62 parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new CollateralMarketValue62(parentElement);
            ...
            element.padding2 = Padding2.parse(container, element);
            element.collateralMarketValueGroups = CollateralMarketValueGroups.parse(container, element);
        ...
        public String toString() {
            ...
            sb.append(this.padding2).append("\n");
            sb.append(this.collateralMarketValueGroups).append("\n");
            return sb.toString();
        }
    }
    ...
    public static class MdPriceLevelOptional implements IBinaryProtocolElement {
        public static final int LENGTH = 1;
        public final IBinaryProtocolElement parent;
        public final Byte value;

        public MdPriceLevelOptional(Byte value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static MdPriceLevelOptional parse(Container container, IBinaryProtocolElement element) {
            return new MdPriceLevelOptional(LittleEndianUtils.toByte(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "mdPriceLevelOptional = "+ this.value;
        }
    }

    // Number Of Orders Optional: 4 Byte Signed Fixed Width Integer Nullable
    public static class NumberOfOrdersOptional implements IBinaryProtocolElement {
        public static final int LENGTH = 4;
        public final IBinaryProtocolElement parent;
        public final Integer value;

        public NumberOfOrdersOptional(Integer value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static NumberOfOrdersOptional parse(Container container, IBinaryProtocolElement element) {
            return new NumberOfOrdersOptional(LittleEndianUtils.toInteger(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "numberOfOrdersOptional = "+ this.value;
        }
    }

    // Tradeable Size: 4 Byte Signed Fixed Width Integer Nullable
    public static class TradeableSize implements IBinaryProtocolElement {
        public static final int LENGTH = 4;
        public final IBinaryProtocolElement parent;
        public final Integer value;

        public TradeableSize(Integer value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static TradeableSize parse(Container container, IBinaryProtocolElement element) {
            return new TradeableSize(LittleEndianUtils.toInteger(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "tradeableSize = "+ this.value;
        }
    }

    // Md Entry Size Optional: 4 Byte Signed Fixed Width Integer Nullable
    public static class MdEntrySizeOptional implements IBinaryProtocolElement {
        public static final int LENGTH = 4;
        public final IBinaryProtocolElement parent;
        public final Integer value;

        public MdEntrySizeOptional(Integer value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static MdEntrySizeOptional parse(Container container, IBinaryProtocolElement element) {
            return new MdEntrySizeOptional(LittleEndianUtils.toInteger(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "mdEntrySizeOptional = "+ this.value;
        }
    }

    // Md Entry Px Optional: 8 Byte Signed Fixed Width Integer Nullable
    public static class MdEntryPxOptional implements IBinaryProtocolElement {
        public static final int LENGTH = 8;
        public final IBinaryProtocolElement parent;
        public final Long value;

        public MdEntryPxOptional(Long value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value/1000000000;
        }

        public static MdEntryPxOptional parse(Container container, IBinaryProtocolElement element) {
            return new MdEntryPxOptional(LittleEndianUtils.toLong(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "mdEntryPxOptional = "+ this.value;
        }
    }
    ...
    */
    public static class SnapshotFullRefreshTcpGroup implements Payload {
        ...
        // constructor for Snapshot Full Refresh Tcp Group
        private SnapshotFullRefreshTcpGroup(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Snapshot Full Refresh Tcp Group
        public static SnapshotFullRefreshTcpGroup parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new SnapshotFullRefreshTcpGroup(parentElement);

            element.mdEntryPxOptional = MdEntryPxOptional.parse(container, element);
            element.mdEntrySizeOptional = MdEntrySizeOptional.parse(container, element);
            element.tradeableSize = TradeableSize.parse(container, element);
            element.numberOfOrdersOptional = NumberOfOrdersOptional.parse(container, element);
            element.mdPriceLevelOptional = MdPriceLevelOptional.parse(container, element);
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(this.mdEntryPxOptional).append("\n");
            sb.append(this.mdEntrySizeOptional).append("\n");
            sb.append(this.tradeableSize).append("\n");
            sb.append(this.numberOfOrdersOptional).append("\n");
            sb.append(this.mdPriceLevelOptional).append("\n");
    ...
    */
    public static class SnapshotFullRefreshTcpGroups implements Payload {
        ...
        // fields
        public GroupSize groupSize;
        public List<SnapshotFullRefreshTcpGroup> snapshotFullRefreshTcpGroupList = new ArrayList<>();

        // constructor for Snapshot Full Refresh Tcp Groups
        private SnapshotFullRefreshTcpGroups(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Snapshot Full Refresh Tcp Groups
        public static SnapshotFullRefreshTcpGroups parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new SnapshotFullRefreshTcpGroups(parentElement);

            element.groupSize = GroupSize.parse(container, element);

            // Snapshot Full Refresh Tcp Group: Struct of 9 fields
            for (int i = 0; i < element.groupSize.numInGroup.value; i++) {
                element.snapshotFullRefreshTcpGroupList.add(SnapshotFullRefreshTcpGroup.parse(container, element));
            }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(this.groupSize).append("\n");
            for (var snapshotFullRefreshTcpGroup: snapshotFullRefreshTcpGroupList) {
                sb.append(snapshotFullRefreshTcpGroup).append("\n");
            }
            return sb.toString();
        }
    }
    ...
    /**
    * Snapshot Full Refresh Tc P 61
    */
    public static class SnapshotFullRefreshTcP61 implements Payload {
        ...
        public SnapshotFullRefreshTcpGroups snapshotFullRefreshTcpGroups;

        // constructor for Snapshot Full Refresh Tc P 61
        private SnapshotFullRefreshTcP61(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Snapshot Full Refresh Tc P 61
        public static SnapshotFullRefreshTcP61 parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new SnapshotFullRefreshTcP61(parentElement);
            ...
            element.snapshotFullRefreshTcpGroups = SnapshotFullRefreshTcpGroups.parse(container, element);
        ...
        public String toString() {
            ...
            sb.append(this.snapshotFullRefreshTcpGroups).append("\n");
            return sb.toString();
        }
    }

    // Aggressor Indicator: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
    public static class AggressorIndicator implements IBinaryProtocolElement {
        public static final int LENGTH = 1;
        public final IBinaryProtocolElement parent;
        public final ENUM_AGGRESSOR_INDICATOR value;

        public AggressorIndicator(ENUM_AGGRESSOR_INDICATOR value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static AggressorIndicator parse(Container container, IBinaryProtocolElement element) {
            return new AggressorIndicator(ENUM_AGGRESSOR_INDICATOR.valueOf((int)LittleEndianUtils.toByte(container, LENGTH)), element);
        }

        @Override
        public String toString() {
            return "aggressorIndicator = "+ this.value.enumType +" ("+ this.value.enumValue +")";
        }
    }
    ...
    public static class Side implements IBinaryProtocolElement {
        ...
        public static Side parse(Container container, IBinaryProtocolElement element) {
            return new Side(ENUM_SIDE.valueOf((int)LittleEndianUtils.toByte(container, LENGTH)), element);
        }
    ...
    */
    public static class SecurityStatusWorkupOrderGroup implements Payload {
        ...
        // constructor for Security Status Workup Order Group
        private SecurityStatusWorkupOrderGroup(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Security Status Workup Order Group
        public static SecurityStatusWorkupOrderGroup parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new SecurityStatusWorkupOrderGroup(parentElement);

            element.orderId = OrderId.parse(container, element);
            element.side = Side.parse(container, element);
            element.aggressorIndicator = AggressorIndicator.parse(container, element);
        ...
        public String toString() {
            ...
            sb.append(this.aggressorIndicator).append("\n");
            return sb.toString();
        }
    }
    ...
    */
    public static class SecurityStatusWorkupOrderGroups implements Payload {
        ...
        // fields
        public GroupSize groupSize;
        public List<SecurityStatusWorkupOrderGroup> securityStatusWorkupOrderGroupList = new ArrayList<>();

        // constructor for Security Status Workup Order Groups
        private SecurityStatusWorkupOrderGroups(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Security Status Workup Order Groups
        public static SecurityStatusWorkupOrderGroups parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new SecurityStatusWorkupOrderGroups(parentElement);

            element.groupSize = GroupSize.parse(container, element);

            // Security Status Workup Order Group: Struct of 3 fields
            for (int i = 0; i < element.groupSize.numInGroup.value; i++) {
                element.securityStatusWorkupOrderGroupList.add(SecurityStatusWorkupOrderGroup.parse(container, element));
            }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(this.groupSize).append("\n");
            for (var securityStatusWorkupOrderGroup: securityStatusWorkupOrderGroupList) {
                sb.append(securityStatusWorkupOrderGroup).append("\n");
            }
            return sb.toString();
        }
    }
    ...
    public static class WorkupTradingStatus implements IBinaryProtocolElement {
        public static final int LENGTH = 1;
        public final IBinaryProtocolElement parent;
        public final ENUM_WORKUP_TRADING_STATUS value;

        public WorkupTradingStatus(ENUM_WORKUP_TRADING_STATUS value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static WorkupTradingStatus parse(Container container, IBinaryProtocolElement element) {
            return new WorkupTradingStatus(ENUM_WORKUP_TRADING_STATUS.valueOf((int)LittleEndianUtils.toByte(container, LENGTH)), element);
        }

        @Override
        public String toString() {
            return "workupTradingStatus = "+ this.value.enumType +" ("+ this.value.enumValue +")";
        }
    }

    // Trade Link Id: 4 Byte Unsigned Fixed Width Integer
    public static class TradeLinkId implements IBinaryProtocolElement {
        public static final int LENGTH = 4;
        public final IBinaryProtocolElement parent;
        public final Integer value;

        public TradeLinkId(Integer value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static TradeLinkId parse(Container container, IBinaryProtocolElement element) {
            return new TradeLinkId(LittleEndianUtils.toInteger(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "tradeLinkId = "+ this.value;
        }
    }
    ...
    /**
    * Security Status Workup 60
    */
    public static class SecurityStatusWorkup60 implements Payload {
        ...
        public SecurityStatusWorkupOrderGroups securityStatusWorkupOrderGroups;

        // constructor for Security Status Workup 60
        private SecurityStatusWorkup60(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Security Status Workup 60
        public static SecurityStatusWorkup60 parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new SecurityStatusWorkup60(parentElement);
            ...
            element.tradeLinkId = TradeLinkId.parse(container, element);
            element.workupTradingStatus = WorkupTradingStatus.parse(container, element);
            ...
            element.securityStatusWorkupOrderGroups = SecurityStatusWorkupOrderGroups.parse(container, element);
        ...
        public String toString() {
            ...
            sb.append(this.tradeLinkId).append("\n");
            sb.append(this.workupTradingStatus).append("\n");
            sb.append(this.haltReason).append("\n");
            sb.append(this.securityTradingEvent).append("\n");
            sb.append(this.securityStatusWorkupOrderGroups).append("\n");
            return sb.toString();
        }
    }
    ...
    */
    public static class SnapshotRefreshTopOrdersGroup implements Payload {
        ...
        // constructor for Snapshot Refresh Top Orders Group
        private SnapshotRefreshTopOrdersGroup(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Snapshot Refresh Top Orders Group
        public static SnapshotRefreshTopOrdersGroup parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new SnapshotRefreshTopOrdersGroup(parentElement);
    ...
    */
    public static class SnapshotRefreshTopOrdersGroups implements Payload {
        ...
        // fields
        public GroupSize groupSize;
        public List<SnapshotRefreshTopOrdersGroup> snapshotRefreshTopOrdersGroupList = new ArrayList<>();

        // constructor for Snapshot Refresh Top Orders Groups
        private SnapshotRefreshTopOrdersGroups(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Snapshot Refresh Top Orders Groups
        public static SnapshotRefreshTopOrdersGroups parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new SnapshotRefreshTopOrdersGroups(parentElement);

            element.groupSize = GroupSize.parse(container, element);

            // Snapshot Refresh Top Orders Group: Struct of 5 fields
            for (int i = 0; i < element.groupSize.numInGroup.value; i++) {
                element.snapshotRefreshTopOrdersGroupList.add(SnapshotRefreshTopOrdersGroup.parse(container, element));
            }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(this.groupSize).append("\n");
            for (var snapshotRefreshTopOrdersGroup: snapshotRefreshTopOrdersGroupList) {
                sb.append(snapshotRefreshTopOrdersGroup).append("\n");
            }
            return sb.toString();
        }
    }
    ...
    */
    public static class SnapshotRefreshTopOrders59 implements Payload {
        ...
        public MatchEventIndicator matchEventIndicator;
        public SecurityId securityId;
        public SnapshotRefreshTopOrdersGroups snapshotRefreshTopOrdersGroups;

        // constructor for Snapshot Refresh Top Orders 59
        private SnapshotRefreshTopOrders59(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Snapshot Refresh Top Orders 59
        public static SnapshotRefreshTopOrders59 parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new SnapshotRefreshTopOrders59(parentElement);

            element.transactTime = TransactTime.parse(container, element);
            element.matchEventIndicator = MatchEventIndicator.parse(container, element);
            element.securityId = SecurityId.parse(container, element);
            element.snapshotRefreshTopOrdersGroups = SnapshotRefreshTopOrdersGroups.parse(container, element);
        ...
        public String toString() {
            ...
            sb.append(this.matchEventIndicator).append("\n");
            sb.append(this.securityId).append("\n");
            sb.append(this.snapshotRefreshTopOrdersGroups).append("\n");
            return sb.toString();
        }
    }
    ...
    */
    ...
    // Inverted Book: 1 Bit
    public static class InvertedBook implements IBinaryProtocolElement {
        public static final int LENGTH = 1;
        public final IBinaryProtocolElement parent;
        public final Byte value;

        public InvertedBook(Byte value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static InvertedBook parse(Container container, IBinaryProtocolElement element) {
            return new InvertedBook(BigEndianUtils.toByte(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "invertedBook = "+ this.value;
        }
    }

    // Is Ao N Instrument: 1 Bit
    public static class IsAoNInstrument implements IBinaryProtocolElement {
        public static final int LENGTH = 1;
        public final IBinaryProtocolElement parent;
        public final Byte value;

        public IsAoNInstrument(Byte value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static IsAoNInstrument parse(Container container, IBinaryProtocolElement element) {
            return new IsAoNInstrument(BigEndianUtils.toByte(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "isAoNInstrument = "+ this.value;
        }
    }

    // Reserved 8: 8 Bit
    public static class Reserved8 implements IBinaryProtocolElement {
        public static final int LENGTH = 8;
        public final IBinaryProtocolElement parent;
        public final Byte value;

        public Reserved8(Byte value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static Reserved8 parse(Container container, IBinaryProtocolElement element) {
            return new Reserved8(BigEndianUtils.toByte(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "reserved8 = "+ this.value;
        }
    }

    // bit values for InstAttribValue
    public static class InstAttribValueBits {
        public static final byte RESERVED_8                               = (byte)(1 << 24);  
        public static final byte IS_AO_N_INSTRUMENT                       = (byte)(1 << 23);  
        public static final byte INVERTED_BOOK                            = (byte)(1 << 22);  
    ...
    public static class InstAttribValue implements IBinaryProtocolElement {
        ...
        // bits
        public final boolean  _reserved8;                              //  0 
        public final boolean  _isAoNInstrument;                        //  1 
        public final boolean  _invertedBook;                           //  2 
        public final boolean  _variableCabEligible;                    //  3 
        public final boolean  _triangulationEligible;                  //  4 
        public final boolean  _impliedMatchingEligibility;             //  5 
        public final boolean  _gtOrdersEligibility;                    //  6 
        public final boolean  _dailyProductEligibility;                //  7 
        public final boolean  _variableProductEligibility;             //  8 
        public final boolean  _decayingProductEligibility;             //  9 
        public final boolean  _zeroPriceOutrightEligible;              //  10
        public final boolean  _rfqCrossEligible;                       //  11
        public final boolean  _volatilityQuotedOption;                 //  12
        public final boolean  _isFractional;                           //  13
        public final boolean  _negativePriceOutrightEligible;          //  14
        public final boolean  _negativeStrikeEligible;                 //  15
        public final boolean  _iLinkIndicativeMassQuotingEligible;     //  16
        public final boolean  _otcEligible;                            //  17
        public final boolean  _efrEligible;                            //  18
        public final boolean  _efsEligible;                            //  19
        public final boolean  _ebfEligible;                            //  20
        public final boolean  _efpEligible;                            //  21
        public final boolean  _blockTradeEligible;                     //  22
        public final boolean  _orderCrossEligible;                     //  23
        public final boolean  _electronicMatchEligible;                //  24

        public InstAttribValue (Integer value, IBinaryProtocolElement element) {
            this._parent = element;

            this._reserved8 = (value & InstAttribValueBits.RESERVED_8) != 0;
            this._isAoNInstrument = (value & InstAttribValueBits.IS_AO_N_INSTRUMENT) != 0;
            this._invertedBook = (value & InstAttribValueBits.INVERTED_BOOK) != 0;
        ...
        public String toString() {
            ...
            sb.append(StringUtils.repeat('.', 0) + (this._reserved8?"1":"0") + StringUtils.repeat('.', 24) +" // Reserved 8\n");
            sb.append(StringUtils.repeat('.', 1) + (this._isAoNInstrument?"1":"0") + StringUtils.repeat('.', 23) +" // Is Ao N Instrument\n");
            sb.append(StringUtils.repeat('.', 2) + (this._invertedBook?"1":"0") + StringUtils.repeat('.', 22) +" // Inverted Book\n");
            sb.append(StringUtils.repeat('.', 3) + (this._variableCabEligible?"1":"0") + StringUtils.repeat('.', 21) +" // Variable Cab Eligible\n");
            sb.append(StringUtils.repeat('.', 4) + (this._triangulationEligible?"1":"0") + StringUtils.repeat('.', 20) +" // Triangulation Eligible\n");
            sb.append(StringUtils.repeat('.', 5) + (this._impliedMatchingEligibility?"1":"0") + StringUtils.repeat('.', 19) +" // Implied Matching Eligibility\n");
            sb.append(StringUtils.repeat('.', 6) + (this._gtOrdersEligibility?"1":"0") + StringUtils.repeat('.', 18) +" // Gt Orders Eligibility\n");
            sb.append(StringUtils.repeat('.', 7) + (this._dailyProductEligibility?"1":"0") + StringUtils.repeat('.', 17) +" // Daily Product Eligibility\n");
            sb.append(StringUtils.repeat('.', 8) + (this._variableProductEligibility?"1":"0") + StringUtils.repeat('.', 16) +" // Variable Product Eligibility\n");
            sb.append(StringUtils.repeat('.', 9) + (this._decayingProductEligibility?"1":"0") + StringUtils.repeat('.', 15) +" // Decaying Product Eligibility\n");
            sb.append(StringUtils.repeat('.', 10) + (this._zeroPriceOutrightEligible?"1":"0") + StringUtils.repeat('.', 14) +" // Zero Price Outright Eligible\n");
            sb.append(StringUtils.repeat('.', 11) + (this._rfqCrossEligible?"1":"0") + StringUtils.repeat('.', 13) +" // Rfq Cross Eligible\n");
            sb.append(StringUtils.repeat('.', 12) + (this._volatilityQuotedOption?"1":"0") + StringUtils.repeat('.', 12) +" // Volatility Quoted Option\n");
            sb.append(StringUtils.repeat('.', 13) + (this._isFractional?"1":"0") + StringUtils.repeat('.', 11) +" // Is Fractional\n");
            sb.append(StringUtils.repeat('.', 14) + (this._negativePriceOutrightEligible?"1":"0") + StringUtils.repeat('.', 10) +" // Negative Price Outright Eligible\n");
            sb.append(StringUtils.repeat('.', 15) + (this._negativeStrikeEligible?"1":"0") + StringUtils.repeat('.', 9) +" // Negative Strike Eligible\n");
            sb.append(StringUtils.repeat('.', 16) + (this._iLinkIndicativeMassQuotingEligible?"1":"0") + StringUtils.repeat('.', 8) +" // I Link Indicative Mass Quoting Eligible\n");
            sb.append(StringUtils.repeat('.', 17) + (this._otcEligible?"1":"0") + StringUtils.repeat('.', 7) +" // Otc Eligible\n");
            sb.append(StringUtils.repeat('.', 18) + (this._efrEligible?"1":"0") + StringUtils.repeat('.', 6) +" // Efr Eligible\n");
            sb.append(StringUtils.repeat('.', 19) + (this._efsEligible?"1":"0") + StringUtils.repeat('.', 5) +" // Efs Eligible\n");
            sb.append(StringUtils.repeat('.', 20) + (this._ebfEligible?"1":"0") + StringUtils.repeat('.', 4) +" // Ebf Eligible\n");
            sb.append(StringUtils.repeat('.', 21) + (this._efpEligible?"1":"0") + StringUtils.repeat('.', 3) +" // Efp Eligible\n");
            sb.append(StringUtils.repeat('.', 22) + (this._blockTradeEligible?"1":"0") + StringUtils.repeat('.', 2) +" // Block Trade Eligible\n");
            sb.append(StringUtils.repeat('.', 23) + (this._orderCrossEligible?"1":"0") + StringUtils.repeat('.', 1) +" // Order Cross Eligible\n");
            sb.append(StringUtils.repeat('.', 24) + (this._electronicMatchEligible?"1":"0") + StringUtils.repeat('.', 0) +" // Electronic Match Eligible\n");
            return sb.toString();
        }
    }
    ...
    */
    ...
    public static class TermCode implements IBinaryProtocolElement {
        public static final int LENGTH = 20;
        public final IBinaryProtocolElement parent;
        public final String value;

        public TermCode(String value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static TermCode parse(Container container, IBinaryProtocolElement element) {
            return new TermCode(BigEndianUtils.toString(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "termCode = "+ this.value;
        }
    }

    // Instrument Guid: 8 Byte Unsigned Fixed Width Integer Nullable
    public static class InstrumentGuid implements IBinaryProtocolElement {
        public static final int LENGTH = 8;
        public final IBinaryProtocolElement parent;
        public final Long value;

        public InstrumentGuid(Long value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static InstrumentGuid parse(Container container, IBinaryProtocolElement element) {
            return new InstrumentGuid(LittleEndianUtils.toLong(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "instrumentGuid = "+ this.value;
        }
    }

    // Market Set: 6 Byte Ascii String
    public static class MarketSet implements IBinaryProtocolElement {
        public static final int LENGTH = 6;
        public final IBinaryProtocolElement parent;
        public final String value;

        public MarketSet(String value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static MarketSet parse(Container container, IBinaryProtocolElement element) {
            return new MarketSet(BigEndianUtils.toString(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "marketSet = "+ this.value;
        }
    }

    // Risk Set: 6 Byte Ascii String
    public static class RiskSet implements IBinaryProtocolElement {
        public static final int LENGTH = 6;
        public final IBinaryProtocolElement parent;
        public final String value;

        public RiskSet(String value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static RiskSet parse(Container container, IBinaryProtocolElement element) {
            return new RiskSet(BigEndianUtils.toString(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "riskSet = "+ this.value;
        }
    }
    ...
    public static class PriceQuoteMethod implements IBinaryProtocolElement {
        public static final int LENGTH = 5;
        public final IBinaryProtocolElement parent;
        public final String value;

        public PriceQuoteMethod(String value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static PriceQuoteMethod parse(Container container, IBinaryProtocolElement element) {
            return new PriceQuoteMethod(BigEndianUtils.toString(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "priceQuoteMethod = "+ this.value;
        }
    }

    // Max No Of Substitutions: 1 Byte Unsigned Fixed Width Integer
    public static class MaxNoOfSubstitutions implements IBinaryProtocolElement {
        public static final int LENGTH = 1;
        public final IBinaryProtocolElement parent;
        public final Byte value;

        public MaxNoOfSubstitutions(Byte value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static MaxNoOfSubstitutions parse(Container container, IBinaryProtocolElement element) {
            return new MaxNoOfSubstitutions(LittleEndianUtils.toByte(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "maxNoOfSubstitutions = "+ this.value;
        }
    }

    // Money Or Par: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
    public static class MoneyOrPar implements IBinaryProtocolElement {
        public static final int LENGTH = 1;
        public final IBinaryProtocolElement parent;
        public final ENUM_MONEY_OR_PAR value;

        public MoneyOrPar(ENUM_MONEY_OR_PAR value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static MoneyOrPar parse(Container container, IBinaryProtocolElement element) {
            return new MoneyOrPar(ENUM_MONEY_OR_PAR.valueOf((int)LittleEndianUtils.toByte(container, LENGTH)), element);
        }

        @Override
        public String toString() {
            return "moneyOrPar = "+ this.value.enumType +" ("+ this.value.enumValue +")";
        }
    }

    // Repo Sub Type: 1 Byte Unsigned Fixed Width Integer Enum with 3 values
    public static class RepoSubType implements IBinaryProtocolElement {
        public static final int LENGTH = 1;
        public final IBinaryProtocolElement parent;
        public final ENUM_REPO_SUB_TYPE value;

        public RepoSubType(ENUM_REPO_SUB_TYPE value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static RepoSubType parse(Container container, IBinaryProtocolElement element) {
            return new RepoSubType(ENUM_REPO_SUB_TYPE.valueOf((int)LittleEndianUtils.toByte(container, LENGTH)), element);
        }

        @Override
        public String toString() {
            return "repoSubType = "+ this.value.enumType +" ("+ this.value.enumValue +")";
        }
    }

    // Termination Type: 8 Byte Ascii String
    public static class TerminationType implements IBinaryProtocolElement {
        public static final int LENGTH = 8;
        public final IBinaryProtocolElement parent;
        public final String value;

        public TerminationType(String value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static TerminationType parse(Container container, IBinaryProtocolElement element) {
            return new TerminationType(BigEndianUtils.toString(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "terminationType = "+ this.value;
        }
    }

    // End Date: 2 Byte Unsigned Fixed Width Integer Nullable
    public static class EndDate implements IBinaryProtocolElement {
        public static final int LENGTH = 2;
        public final IBinaryProtocolElement parent;
        public final Short value;

        public EndDate(Short value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static EndDate parse(Container container, IBinaryProtocolElement element) {
            return new EndDate(LittleEndianUtils.toShort(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "endDate = "+ this.value;
        }
    }

    // Start Date: 2 Byte Unsigned Fixed Width Integer Nullable
    public static class StartDate implements IBinaryProtocolElement {
        public static final int LENGTH = 2;
        public final IBinaryProtocolElement parent;
        public final Short value;

        public StartDate(Short value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static StartDate parse(Container container, IBinaryProtocolElement element) {
            return new StartDate(LittleEndianUtils.toShort(container, LENGTH), element);
        }
    ...
    public static class PartyRoleClearingOrg implements IBinaryProtocolElement {
        public static final int LENGTH = 5;
        public final IBinaryProtocolElement parent;
        public final String value;

        public PartyRoleClearingOrg(String value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static PartyRoleClearingOrg parse(Container container, IBinaryProtocolElement element) {
            return new PartyRoleClearingOrg(BigEndianUtils.toString(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "partyRoleClearingOrg = "+ this.value;
        }
    }

    // Financial Instrument Full Name: 35 Byte Ascii String
    public static class FinancialInstrumentFullName implements IBinaryProtocolElement {
        public static final int LENGTH = 35;
        public final IBinaryProtocolElement parent;
        public final String value;

        public FinancialInstrumentFullName(String value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static FinancialInstrumentFullName parse(Container container, IBinaryProtocolElement element) {
            return new FinancialInstrumentFullName(BigEndianUtils.toString(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "financialInstrumentFullName = "+ this.value;
        }
    }
    ...
    public static class TotNumReportsOptional implements IBinaryProtocolElement {
        public static final int LENGTH = 4;
        public final IBinaryProtocolElement parent;
        public final Integer value;

        public TotNumReportsOptional(Integer value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static TotNumReportsOptional parse(Container container, IBinaryProtocolElement element) {
            return new TotNumReportsOptional(LittleEndianUtils.toInteger(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "totNumReportsOptional = "+ this.value;
        }
    }

    /**
    * Md Instrument Definition Repo 58
    */
    public static class MdInstrumentDefinitionRepo58 implements Payload {
        ...
        // constructor for Md Instrument Definition Repo 58
        private MdInstrumentDefinitionRepo58(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Md Instrument Definition Repo 58
        public static MdInstrumentDefinitionRepo58 parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new MdInstrumentDefinitionRepo58(parentElement);

            element.matchEventIndicator = MatchEventIndicator.parse(container, element);
            element.totNumReportsOptional = TotNumReportsOptional.parse(container, element);
            ...
            element.lowLimitPrice = LowLimitPrice.parse(container, element);
            element.maxPriceVariation = MaxPriceVariation.parse(container, element);
            element.financialInstrumentFullName = FinancialInstrumentFullName.parse(container, element);
            element.partyRoleClearingOrg = PartyRoleClearingOrg.parse(container, element);
            element.startDate = StartDate.parse(container, element);
            element.endDate = EndDate.parse(container, element);
            element.terminationType = TerminationType.parse(container, element);
            element.repoSubType = RepoSubType.parse(container, element);
            element.moneyOrPar = MoneyOrPar.parse(container, element);
            element.maxNoOfSubstitutions = MaxNoOfSubstitutions.parse(container, element);
            element.priceQuoteMethod = PriceQuoteMethod.parse(container, element);
            element.userDefinedInstrument = UserDefinedInstrument.parse(container, element);
            element.riskSet = RiskSet.parse(container, element);
            element.marketSet = MarketSet.parse(container, element);
            element.instrumentGuid = InstrumentGuid.parse(container, element);
            element.termCode = TermCode.parse(container, element);
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(this.matchEventIndicator).append("\n");
            sb.append(this.totNumReportsOptional).append("\n");
            ...
            sb.append(this.lowLimitPrice).append("\n");
            sb.append(this.maxPriceVariation).append("\n");
            sb.append(this.financialInstrumentFullName).append("\n");
            sb.append(this.partyRoleClearingOrg).append("\n");
            sb.append(this.startDate).append("\n");
            sb.append(this.endDate).append("\n");
            sb.append(this.terminationType).append("\n");
            sb.append(this.repoSubType).append("\n");
            sb.append(this.moneyOrPar).append("\n");
            sb.append(this.maxNoOfSubstitutions).append("\n");
            sb.append(this.priceQuoteMethod).append("\n");
            sb.append(this.userDefinedInstrument).append("\n");
            sb.append(this.riskSet).append("\n");
            sb.append(this.marketSet).append("\n");
            sb.append(this.instrumentGuid).append("\n");
            sb.append(this.termCode).append("\n");
    ...
    public static class SecurityAltIdSource implements IBinaryProtocolElement {
        public static final int LENGTH = 1;
        public final IBinaryProtocolElement parent;
        public final ENUM_SECURITY_ALT_ID_SOURCE value;

        public SecurityAltIdSource(ENUM_SECURITY_ALT_ID_SOURCE value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static SecurityAltIdSource parse(Container container, IBinaryProtocolElement element) {
            return new SecurityAltIdSource(ENUM_SECURITY_ALT_ID_SOURCE.valueOf((int)LittleEndianUtils.toByte(container, LENGTH)), element);
        }

        @Override
        public String toString() {
            return "securityAltIdSource = "+ this.value.enumType +" ("+ this.value.enumValue +")";
        }
    }

    // Security Alt Id: 12 Byte Ascii String
    public static class SecurityAltId implements IBinaryProtocolElement {
        public static final int LENGTH = 12;
        public final IBinaryProtocolElement parent;
        public final String value;

        public SecurityAltId(String value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static SecurityAltId parse(Container container, IBinaryProtocolElement element) {
            return new SecurityAltId(BigEndianUtils.toString(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "securityAltId = "+ this.value;
        }
    }

    // Issuer: 25 Byte Ascii String
    public static class Issuer implements IBinaryProtocolElement {
        public static final int LENGTH = 25;
        public final IBinaryProtocolElement parent;
        public final String value;

        public Issuer(String value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static Issuer parse(Container container, IBinaryProtocolElement element) {
            return new Issuer(BigEndianUtils.toString(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "issuer = "+ this.value;
        }
    }

    // Country Of Issue: 2 Byte Ascii String
    public static class CountryOfIssue implements IBinaryProtocolElement {
        public static final int LENGTH = 2;
        public final IBinaryProtocolElement parent;
        public final String value;

        public CountryOfIssue(String value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static CountryOfIssue parse(Container container, IBinaryProtocolElement element) {
            return new CountryOfIssue(BigEndianUtils.toString(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "countryOfIssue = "+ this.value;
        }
    }

    // Coupon Day Count: 20 Byte Ascii String
    public static class CouponDayCount implements IBinaryProtocolElement {
        public static final int LENGTH = 20;
        public final IBinaryProtocolElement parent;
        public final String value;

        public CouponDayCount(String value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static CouponDayCount parse(Container container, IBinaryProtocolElement element) {
            return new CouponDayCount(BigEndianUtils.toString(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "couponDayCount = "+ this.value;
        }
    }

    // Coupon Frequency Period: 2 Byte Unsigned Fixed Width Integer Nullable
    public static class CouponFrequencyPeriod implements IBinaryProtocolElement {
        public static final int LENGTH = 2;
        public final IBinaryProtocolElement parent;
        public final Short value;

        public CouponFrequencyPeriod(Short value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static CouponFrequencyPeriod parse(Container container, IBinaryProtocolElement element) {
            return new CouponFrequencyPeriod(LittleEndianUtils.toShort(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "couponFrequencyPeriod = "+ this.value;
        }
    }

    // Coupon Frequency Unit: 3 Byte Ascii String
    public static class CouponFrequencyUnit implements IBinaryProtocolElement {
        public static final int LENGTH = 3;
        public final IBinaryProtocolElement parent;
        public final String value;

        public CouponFrequencyUnit(String value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static CouponFrequencyUnit parse(Container container, IBinaryProtocolElement element) {
            return new CouponFrequencyUnit(BigEndianUtils.toString(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "couponFrequencyUnit = "+ this.value;
        }
    }

    // Par Value: 8 Byte Signed Fixed Width Integer Nullable
    public static class ParValue implements IBinaryProtocolElement {
        public static final int LENGTH = 8;
        public final IBinaryProtocolElement parent;
        public final Long value;

        public ParValue(Long value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value/1000000000;
        }

        public static ParValue parse(Container container, IBinaryProtocolElement element) {
            return new ParValue(LittleEndianUtils.toLong(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "parValue = "+ this.value;
        }
    }
    ...
    public static class CouponRate implements IBinaryProtocolElement {
        ...
        public CouponRate(Long value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value/1000000000;
        }

        public static CouponRate parse(Container container, IBinaryProtocolElement element) {
            return new CouponRate(LittleEndianUtils.toLong(container, LENGTH), element);
        }
    ...
    public static class MaturityDate implements IBinaryProtocolElement {
        public static final int LENGTH = 2;
        public final IBinaryProtocolElement parent;
        public final Short value;

        public MaturityDate(Short value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static MaturityDate parse(Container container, IBinaryProtocolElement element) {
            return new MaturityDate(LittleEndianUtils.toShort(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "maturityDate = "+ this.value;
        }
    }

    // Dated Date: 2 Byte Unsigned Fixed Width Integer Nullable
    public static class DatedDate implements IBinaryProtocolElement {
        public static final int LENGTH = 2;
        public final IBinaryProtocolElement parent;
        public final Short value;

        public DatedDate(Short value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static DatedDate parse(Container container, IBinaryProtocolElement element) {
            return new DatedDate(LittleEndianUtils.toShort(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "datedDate = "+ this.value;
        }
    }

    // Issue Date: 2 Byte Unsigned Fixed Width Integer Nullable
    public static class IssueDate implements IBinaryProtocolElement {
        public static final int LENGTH = 2;
        public final IBinaryProtocolElement parent;
        public final Short value;

        public IssueDate(Short value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static IssueDate parse(Container container, IBinaryProtocolElement element) {
            return new IssueDate(LittleEndianUtils.toShort(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "issueDate = "+ this.value;
        }
    }
    ...
    public static class MinPriceIncrementOptional implements IBinaryProtocolElement {
        public static final int LENGTH = 8;
        public final IBinaryProtocolElement parent;
        public final Long value;

        public MinPriceIncrementOptional(Long value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value/1000000000;
        }

        public static MinPriceIncrementOptional parse(Container container, IBinaryProtocolElement element) {
            return new MinPriceIncrementOptional(LittleEndianUtils.toLong(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "minPriceIncrementOptional = "+ this.value;
        }
    }

    /**
    * Md Instrument Definition Fixed Income 57
    */
    public static class MdInstrumentDefinitionFixedIncome57 implements Payload {
        ...
        // constructor for Md Instrument Definition Fixed Income 57
        private MdInstrumentDefinitionFixedIncome57(IBinaryProtocolElement element) {
            this.parent = element;
        }

        // parser for Md Instrument Definition Fixed Income 57
        public static MdInstrumentDefinitionFixedIncome57 parse(Container container, IBinaryProtocolElement parentElement) {
            var element = new MdInstrumentDefinitionFixedIncome57(parentElement);
            ...
            element.minTradeVol = MinTradeVol.parse(container, element);
            element.maxTradeVol = MaxTradeVol.parse(container, element);
            element.minPriceIncrementOptional = MinPriceIncrementOptional.parse(container, element);
            element.displayFactor = DisplayFactor.parse(container, element);
            ...
            element.issueDate = IssueDate.parse(container, element);
            element.datedDate = DatedDate.parse(container, element);
            element.maturityDate = MaturityDate.parse(container, element);
            element.couponRate = CouponRate.parse(container, element);
            element.parValue = ParValue.parse(container, element);
            element.couponFrequencyUnit = CouponFrequencyUnit.parse(container, element);
            element.couponFrequencyPeriod = CouponFrequencyPeriod.parse(container, element);
            element.couponDayCount = CouponDayCount.parse(container, element);
            element.countryOfIssue = CountryOfIssue.parse(container, element);
            element.issuer = Issuer.parse(container, element);
            element.financialInstrumentFullName = FinancialInstrumentFullName.parse(container, element);
            element.securityAltId = SecurityAltId.parse(container, element);
            element.securityAltIdSource = SecurityAltIdSource.parse(container, element);
            element.priceQuoteMethod = PriceQuoteMethod.parse(container, element);
            element.partyRoleClearingOrg = PartyRoleClearingOrg.parse(container, element);
            element.userDefinedInstrument = UserDefinedInstrument.parse(container, element);
            element.riskSet = RiskSet.parse(container, element);
        ...
        public String toString() {
            ...
            sb.append(this.minTradeVol).append("\n");
            sb.append(this.maxTradeVol).append("\n");
            sb.append(this.minPriceIncrementOptional).append("\n");
            sb.append(this.displayFactor).append("\n");
            ...
            sb.append(this.datedDate).append("\n");
            sb.append(this.maturityDate).append("\n");
            sb.append(this.couponRate).append("\n");
            sb.append(this.parValue).append("\n");
            sb.append(this.couponFrequencyUnit).append("\n");
            sb.append(this.couponFrequencyPeriod).append("\n");
            sb.append(this.couponDayCount).append("\n");
            sb.append(this.countryOfIssue).append("\n");
            sb.append(this.issuer).append("\n");
            sb.append(this.financialInstrumentFullName).append("\n");
            sb.append(this.securityAltId).append("\n");
            sb.append(this.securityAltIdSource).append("\n");
            sb.append(this.priceQuoteMethod).append("\n");
            sb.append(this.partyRoleClearingOrg).append("\n");
            sb.append(this.userDefinedInstrument).append("\n");
            sb.append(this.riskSet).append("\n");
    ...
    */
    ...
    public static class UnderlyingProductOptional implements IBinaryProtocolElement {
        public static final int LENGTH = 1;
        public final IBinaryProtocolElement parent;
        public final Byte value;

        public UnderlyingProductOptional(Byte value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static UnderlyingProductOptional parse(Container container, IBinaryProtocolElement element) {
            return new UnderlyingProductOptional(LittleEndianUtils.toByte(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "underlyingProductOptional = "+ this.value;
        }
    }
    ...
    */
    public static class MdInstrumentDefinitionSpread56 implements Payload {
        ...
        public static MdInstrumentDefinitionSpread56 parse(Container container, IBinaryProtocolElement parentElement) {
            ...
            element.applId = ApplId.parse(container, element);
            element.marketSegmentId = MarketSegmentId.parse(container, element);
            element.underlyingProductOptional = UnderlyingProductOptional.parse(container, element);
            element.securityExchange = SecurityExchange.parse(container, element);
            element.securityGroup = SecurityGroup.parse(container, element);
            element.asset = Asset.parse(container, element);
            element.symbol = Symbol.parse(container, element);
        ...
        public String toString() {
            ...
            sb.append(this.applId).append("\n");
            sb.append(this.marketSegmentId).append("\n");
            sb.append(this.underlyingProductOptional).append("\n");
            sb.append(this.securityExchange).append("\n");
            sb.append(this.securityGroup).append("\n");
            sb.append(this.asset).append("\n");
            sb.append(this.symbol).append("\n");
    ...
    */
    ...
    public static class MdOrderPriorityOptional implements IBinaryProtocolElement {
        public static final int LENGTH = 8;
        public final IBinaryProtocolElement parent;
        public final Long value;

        public MdOrderPriorityOptional(Long value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static MdOrderPriorityOptional parse(Container container, IBinaryProtocolElement element) {
            return new MdOrderPriorityOptional(LittleEndianUtils.toLong(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "mdOrderPriorityOptional = "+ this.value;
        }
    }
    ...
    */
    public static class SnapshotFullRefreshOrderBookGroup implements Payload {
        ...
        public static SnapshotFullRefreshOrderBookGroup parse(Container container, IBinaryProtocolElement parentElement) {
            ...
            element.orderId = OrderId.parse(container, element);
            element.mdOrderPriorityOptional = MdOrderPriorityOptional.parse(container, element);
            element.mdEntryPx = MdEntryPx.parse(container, element);
            element.mdDisplayQty = MdDisplayQty.parse(container, element);
            element.mdEntryTypeBook = MdEntryTypeBook.parse(container, element);
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(this.orderId).append("\n");
            sb.append(this.mdOrderPriorityOptional).append("\n");
            sb.append(this.mdEntryPx).append("\n");
            sb.append(this.mdDisplayQty).append("\n");
            sb.append(this.mdEntryTypeBook).append("\n");
            return sb.toString();
    ...
    */
    ...
    public static class MdDisplayQtyOptional implements IBinaryProtocolElement {
        public static final int LENGTH = 4;
        public final IBinaryProtocolElement parent;
        public final Integer value;

        public MdDisplayQtyOptional(Integer value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static MdDisplayQtyOptional parse(Container container, IBinaryProtocolElement element) {
            return new MdDisplayQtyOptional(LittleEndianUtils.toInteger(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "mdDisplayQtyOptional = "+ this.value;
        }
    }

    // Order Id Optional: 8 Byte Unsigned Fixed Width Integer Nullable
    public static class OrderIdOptional implements IBinaryProtocolElement {
        public static final int LENGTH = 8;
        public final IBinaryProtocolElement parent;
        public final Long value;

        public OrderIdOptional(Long value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static OrderIdOptional parse(Container container, IBinaryProtocolElement element) {
            return new OrderIdOptional(LittleEndianUtils.toLong(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "orderIdOptional = "+ this.value;
        }
    }
    ...
    */
    public static class MDIncrementalRefreshOrderBookGroup implements Payload {
        ...
        public static MDIncrementalRefreshOrderBookGroup parse(Container container, IBinaryProtocolElement parentElement) {
            ...
            element.orderIdOptional = OrderIdOptional.parse(container, element);
            element.mdOrderPriorityOptional = MdOrderPriorityOptional.parse(container, element);
            element.mdEntryPxOptional = MdEntryPxOptional.parse(container, element);
            element.mdDisplayQtyOptional = MdDisplayQtyOptional.parse(container, element);
            element.securityId = SecurityId.parse(container, element);
            element.mdUpdateAction = MdUpdateAction.parse(container, element);
            element.mdEntryTypeBook = MdEntryTypeBook.parse(container, element);
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(this.orderIdOptional).append("\n");
            sb.append(this.mdOrderPriorityOptional).append("\n");
            sb.append(this.mdEntryPxOptional).append("\n");
            sb.append(this.mdDisplayQtyOptional).append("\n");
            sb.append(this.securityId).append("\n");
            sb.append(this.mdUpdateAction).append("\n");
            sb.append(this.mdEntryTypeBook).append("\n");
    ...
    */
    ...
    public static class SideOptional implements IBinaryProtocolElement {
        public static final int LENGTH = 1;
        public final IBinaryProtocolElement parent;
        public final Byte value;

        public SideOptional(Byte value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static SideOptional parse(Container container, IBinaryProtocolElement element) {
            return new SideOptional(LittleEndianUtils.toByte(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "sideOptional = "+ this.value;
        }
    }
    ...
    */
    public static class RelatedSymGroup implements Payload {
        ...
        public static RelatedSymGroup parse(Container container, IBinaryProtocolElement parentElement) {
            ...
            element.sideOptional = SideOptional.parse(container, element);
            element.padding2 = Padding2.parse(container, element);
        ...
        public String toString() {
            ...
            sb.append(this.sideOptional).append("\n");
            sb.append(this.padding2).append("\n");
            return sb.toString();
        }
    }
    ...
    */
    ...
    public static class SecurityIdOptional implements IBinaryProtocolElement {
        public static final int LENGTH = 4;
        public final IBinaryProtocolElement parent;
        public final Integer value;

        public SecurityIdOptional(Integer value, IBinaryProtocolElement element) {
            this.parent = element;
            this.value = value;
        }

        public static SecurityIdOptional parse(Container container, IBinaryProtocolElement element) {
            return new SecurityIdOptional(LittleEndianUtils.toInteger(container, LENGTH), element);
        }

        @Override
        public String toString() {
            return "securityIdOptional = "+ this.value;
        }
    }
    ...
    */
    public static class SecurityStatus30 implements Payload {
        ...
        public static SecurityStatus30 parse(Container container, IBinaryProtocolElement parentElement) {
            ...
            element.securityGroup = SecurityGroup.parse(container, element);
            element.asset = Asset.parse(container, element);
            element.securityIdOptional = SecurityIdOptional.parse(container, element);
            element.tradeDate = TradeDate.parse(container, element);
            element.matchEventIndicator = MatchEventIndicator.parse(container, element);
        ...
        public String toString() {
            ...
            sb.append(this.securityGroup).append("\n");
            sb.append(this.asset).append("\n");
            sb.append(this.securityIdOptional).append("\n");
            sb.append(this.tradeDate).append("\n");
            sb.append(this.matchEventIndicator).append("\n");
    ...
    */
    public static Payload parsePayload(Container container, ENUM_TEMPLATE_ID templateId) {
        ...
        // -- parsing Md Instrument Definition Fixed Income 57
        if (templateId.enumType == 57) {
            return MdInstrumentDefinitionFixedIncome57.parse(container, null);
        }
        // -- parsing Md Instrument Definition Repo 58
        if (templateId.enumType == 58) {
            return MdInstrumentDefinitionRepo58.parse(container, null);
        }
        // -- parsing Snapshot Refresh Top Orders 59
        if (templateId.enumType == 59) {
            return SnapshotRefreshTopOrders59.parse(container, null);
        }
        // -- parsing Security Status Workup 60
        if (templateId.enumType == 60) {
            return SecurityStatusWorkup60.parse(container, null);
        }
        // -- parsing Snapshot Full Refresh Tc P 61
        if (templateId.enumType == 61) {
            return SnapshotFullRefreshTcP61.parse(container, null);
        }
        // -- parsing Collateral Market Value 62
        if (templateId.enumType == 62) {
            return CollateralMarketValue62.parse(container, null);
        }
